...
| `JWT_RESTRICTION_HEADER       | unset         | If set, the JWT is only valid if the current value of this header matched the value when the JWT was created. Example: `X-Real-IP`                  |
